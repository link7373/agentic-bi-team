...
4. **Model:** Prefer interpretable and boring (logistic regression, gradient-boosted trees, ARIMA/ETS or Prophet-style for forecasts) unless the problem demands more. Proper splits: time-based for anything temporal, grouped by entity where entities repeat. Cross-validate; tune modestly.
