...
for warehouse access. Tier 1 needs nothing beyond Power BI Desktop and Python.
...
every write as outward-facing: publishing a dashboard to a workspace is covered by
`CLAUDE.md §8` and needs confirmation first. See `publishing.md`.
